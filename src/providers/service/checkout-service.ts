...
export class CheckoutService {
    ...
    updateOrderReview(form) {
        ...
        return new Promise(resolve => {
            this.http.post(this.url + '/wp-admin/admin-ajax.php?action=mstoreapp-update_order_review', params, {
                    headers: headers
                }).map(res => res.json())
                .subscribe(data => {
                    this.status = data;
    ...
    saveShippingAddress(shipping) {
        ...
        return new Promise(resolve => {
            this.http.post(this.url + '/wp-admin/admin-ajax.php?action=mstoreapp-get_checkout_form', params, {
                    headers: headers
                }).map(res => res.json())
                .subscribe(data => {
                    this.status = data;
    ...
    getShippingPayment() {
        ...
        return new Promise(resolve => {
            Observable.forkJoin(
                this.http.get(this.url + '/wp-admin/admin-ajax.php?action=mstoreapp-payment').map(res => res.json())
            ).subscribe(data => {
    ...
    saveMethods(shippingMethod, payment) {
        ...
        return new Promise(resolve => {
            Observable.forkJoin(
                this.http.post(this.url + '/wp-admin/admin-ajax.php?action=mstoreapp-payment', params).map(res => res.json())
            ).subscribe(data => {
    ...
    getTime(date) {
        ...
        console.log(params);
        return new Promise(resolve => {
            this.http.post(this.url + '/wp-admin/admin-ajax.php', params).map(res => res.json())
                .subscribe(data => {
                    this.status = data;
                    console.log(data);
                    resolve(this.status);
